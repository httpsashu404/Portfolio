...
import { FaAtlassian, FaHandPointDown } from "react-icons/fa";
...
const Contact = () => {
  ...
  function sendEmail(e) {
    e.preventDefault();
    try {
      const result = emailjs.sendForm('service_ak0ix5o', 'template_8djrqwb', e.target, 'PCz5wsES63NLXuwj-')
      if (result) {
                ...
                <div className="card2 d-flex card border-0 px-4 py-2">
                  <div className="row">
                    <div className="row">
                      <h6 className="text-center">
                        ...
                        <a className="btn" onClick={Youtube}><SiYoutube color="red" size={25} /></a>
                      </h6>
                    </div>
                  </div>
                  ...
                  <div className="row px-3 mb-4">
                    <form onSubmit={sendEmail}>
                      ...
                      <div className="mb-3">
                        <input type="tel" name="tel" className="form-control" id=" " maxLength={10} placeholder="Your phone" required />
                      </div>
                      <div className="mb-3">
